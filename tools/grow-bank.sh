...
#
# Usage:
#   tools/grow-bank.sh [COUNT]      # default COUNT=300
#
...
echo "▶ growing question bank by ~${COUNT} (Nemotron generate + Sonnet verify)"
...
Generated via Nemotron 3 Ultra (free), independently verified by Claude
Sonnet, deduped against the full existing pool before merge.
